...
namespace I2.Loc
{
	public partial class LocalizationEditor
	{
		...
		void ReplaceSelectedTerms()
		{
			...
			//--[ Create new Term ]-----------------------
			if (LocalizationEditorDB.mLanguageSource.GetTermData(sNewKey)==null)
			{
				...
				{
					oldTerm = LocalizationEditorDB.mLanguageSource.GetTermData(mSelectedKeys[i]);
			...
			string mNewCategory = LocalizationEditorDB.GetCategoryFromFullTerm(sNewKey);
